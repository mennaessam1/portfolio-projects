...
import { changeSellerPassword } from "@/api/SellerProfileApi";
...
const ChangePassword: React.FC<ChangePasswordProps> = ( {id }) => {
  ...
  const onSubmit: SubmitHandler<FormData> = async (data) => {
    ...
    try {
      ...
      const response = await changeSellerPassword(id, data.oldPassword, data.newPassword, data.confirmNewPassword);
